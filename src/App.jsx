...
3. **성경 인용 밸런스 (핵심!):**
   ...
   **구절 인용 방식 (매우 중요!):**
   ...
   - 예시 1: "핵심이 되는 구절을 함께 읽어보겠습니다. 5절 말씀입니다. '여호와께서...(구절 내용)'"
   - 예시 2: "오늘 본문에서 3절, 12절, 17절을 함께 살펴보겠습니다. 먼저 3절입니다. '...(구절 내용)'"
   - 예시 3: "이 장의 핵심은 8절에 담겨 있습니다. '...(구절 내용)'"
   - 절대로 구절 번호 없이 인용하지 마세요
   - 인용 후에도 "방금 읽은 5절에서..." 처럼 구절 번호를 다시 언급하며 설명하세요
